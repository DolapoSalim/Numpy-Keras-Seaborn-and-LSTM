...
# Full notebook content structured as a Python dictionary
notebook = {
 "cells": [
  {
   "cell_type": "markdown",
...
# Save the notebook
notebook_path = Path(r"c:\Users\dolap\OneDrive\Documents\DOLAPO\data-analysis\sklearn-image-multidimensional-analysis\Numpy-Keras-Seaborn-and-LSTM-2\Full_DSA_for_Ecology_and_DL.ipynb")
